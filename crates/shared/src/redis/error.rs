...
impl RedisError {
    ...
    pub fn message(&self) -> String {
        match self {
            ...
            RedisError::DelHashFieldFailed(err) => format!("Redis Error : {err}"),
    ...
    fn code(&self) -> String {
        match self {
            ...
            RedisError::DelHashFieldFailed(_) => "DELHASHFIELD_FAILED",
...
impl ResponseError for RedisError {
    ...
    fn status_code(&self) -> StatusCode {
        match self {
            ...
            RedisError::DelHashFieldFailed(_) => StatusCode::INTERNAL_SERVER_ERROR,
